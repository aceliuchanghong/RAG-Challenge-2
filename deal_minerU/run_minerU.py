...
if __name__ == "__main__":
    """
    mineru/cli/vlm_sglang_server.py==>mineru/model/vlm_sglang_model/server.py

    mineru-sglang-server --port 30000 --model-path /mnt/data/llch/Models/minerU_models
    ...
    uv run run_minerU.py
    """
    __dir__ = os.path.dirname(os.path.abspath(__file__))
    pdf_files_dir = "/mnt/data/llch/my_lm_log/no_git_oic/images/"
    pdf_files_dir = "/mnt/data/llch/RAG-Challenge-2/no_git_oic/"
    output_dir = os.path.join(__dir__, "output")
    pdf_suffixes = [".pdf"]
    image_suffixes = [".png", ".jpeg", ".jpg"]
    model_path = "/mnt/data/llch/Models/minerU_models/"
    ...
    """如果网络问题无法下载模型 可以设置环境变量MINERU_MODEL_SOURCE为modelscope使用免代理仓库下载模型"""
